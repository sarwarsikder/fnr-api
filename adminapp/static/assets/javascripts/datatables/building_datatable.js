        ...
        "columnDefs": [
            {
                ...
                'render': function (data, type, full, meta) {
                    ...
                    var task_url = base_url+"/buildings/"+full[0]+"/tasks/";
                    var actions = '<a href="'+updateUrl+'" class="btn btn-primary btn-lil building-info" data-toggle="tooltip" data-placement="top" title="Edit Hause" data-original-title="Edit"><i class="fa fa-edit"></i></a>'+
                                  '<a href="'+flat_url+'" class="btn btn-primary btn-lil building-flats" data-toggle="tooltip" data-placement="top" title="Hause Whonung"><i class="fa fa-door-closed"></i></a>'+
